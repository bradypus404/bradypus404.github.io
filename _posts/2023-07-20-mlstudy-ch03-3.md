...
```
train 점수는 규제를 하기 전보다 낮아졌지만 test 점수는 규제를 한 후가 근소하게 증가한 것을 볼 수 있다.<br>
...
plt.show()
```
![(3-3]-1_릿지_결과](/assets/images/post/2023-07-20_[3-3]/(3-3)-1_ridge_alpha.png)
